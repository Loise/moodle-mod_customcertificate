...
git://github.com/bozoh/moodle-mod_customcertificate.git, remember to
rename the folder to certificate if you do not specify this in the clone command

Eg. Linux command line would be as follow -

git clone git://github.com/bozoh/moodle-mod_customcertificate.git customcertificate
...
Visit https://github.com/bozoh/moodle-mod_customcertificate, choose the branch
...
name similar to bozoh-moodle-mod_customcertificate-c9fbadb, you MUST rename this to customcertificate. 
